#hash((0
       .
       #s(target-file
          "/Users/nhejduk/Documents/Research-Cloud/teco-parent/contracts-and-testing/bex/orchestration/../../../gtp-benchmarks/benchmarks/kcfa/original/main.rkt"
          ()))
      (1
       .
       #s(context
          ...
          ()))
      (2 . #s(test 1 (check-equal? (analyze smallest-example) (hash)) ()))
      (3
       .
       #s(context
          1
