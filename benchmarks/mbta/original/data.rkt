...
(define/ctc-helper
 ...
 (flat-named-contract
  ...
  (λ (fuel) (thunk (list-ref color-list (random (length color-list)))))))
...
(define/ctc-helper
 ...
 (flat-named-contract
  ...
  (λ (fuel)
    (thunk (list-ref expected-lines (random (length expected-lines)))))))
...
(define/ctc-helper
 ...
 (flat-named-contract
  ...
  (λ (fuel)
    (thunk (list-ref expected-stations (random (length expected-stations)))))))
